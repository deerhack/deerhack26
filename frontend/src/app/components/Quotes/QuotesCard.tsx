        ...
        <>
            <div className="md:flex md:flex-row justify-center items-center gap-9 sm:flex sm:flex-col">
                <div className="photo flex justify-center items-center">
                    <div className="w-[19.125rem] lg:w-[20.763rem] h-[29.096rem] lg:h-[28.133rem] primary-gradient-background rounded-[1rem] p-[0.1875rem] relative">
                        <div className="w-full h-full legacy-gradient-background rounded-[1rem] p-[0.1rem] flex flex-col">
                            <div className="flex-1 flex justify-center items-center">
                                {photo}
                            </div>
                            <div className="z-50 bg-[#110C24] flex justify-start p-3 rounded-[1rem] mt-2">
                                <div className="flex flex-col">
                                    <div className={`${cabinetBold.className} text-[1.125rem]`}>{name}</div>
                                    <div className={`${cabinetMedium.className} text-[0.875rem]`}>{position}</div>
                                </div>
                            </div>
                        </div>
                    </div>
