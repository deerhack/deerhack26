...
export const details = [
	...
	},
	{
		svg: CollegeSVG,
		id: 3,
		title: "Deerwalk College",
		desc: "Deerwalk Institute of Technology (DWIT) is an educational institution that prepares students and professionals of all levels to meet the problems and grab the possibilities of the twenty-first century IT Industry. The institute is well-known for its approach to learning that is both open-minded and responsible. It has an affiliation with Tribhuvan University and offers two undergraduate degrees, BSc. CSIT and BCA. By integrating rigorous technical training with a focus on soft skills and entrepreneurship, the college bridges the gap between theoretical education and the fast-paced demands of the global tech market. The campus serves as a vibrant ecosystem for innovation, hosting various student-led clubs and workshops that foster a culture of continuous learning and professional growth.",
	},
];
