...
export default function ExpectationPageV2(): ReactElement {
  return (
    <div className="relative bg-dark-purple py-20 flex flex-col gap-[20px] overflow-hidden md:overflow-visible">
      ...
      <Butterfly className="absolute w-[86px] h-[105px] top-40 left-8 md:w-[144px] md:h-[188px] md:top-[120px] lg:top-[180px] md:left-[140px] z-[45]" />
      <ExpectationCards />
